...
#
# Created: Sat Nov 05 20:42:13 2016
...
class Ui_VectorDXF(object):
    def setupUi(self, VectorDXF):
        ...
        self.gridLayout.addWidget(self.pushButtonCreate, 13, 0, 1, 5)
        self.doubleSpinBoxScale = QtGui.QDoubleSpinBox(VectorDXF)
        self.doubleSpinBoxScale.setMinimumSize(QtCore.QSize(100, 0))
        self.doubleSpinBoxScale.setMaximumSize(QtCore.QSize(100, 16777215))
        self.doubleSpinBoxScale.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.doubleSpinBoxScale.setDecimals(3)
        self.doubleSpinBoxScale.setMinimum(0.0)
        self.doubleSpinBoxScale.setMaximum(99999999.0)
        self.doubleSpinBoxScale.setSingleStep(0.5)
        self.doubleSpinBoxScale.setProperty("value", 10.0)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxDX, 2, 2, 1, 1)
        self.lineEditOutput = QtGui.QLineEdit(VectorDXF)
        self.lineEditOutput.setObjectName(_fromUtf8("lineEditOutput"))
        self.gridLayout.addWidget(self.lineEditOutput, 11, 2, 1, 3)
        self.label_38 = QtGui.QLabel(VectorDXF)
        self.label_38.setIndent(18)
        self.label_38.setObjectName(_fromUtf8("label_38"))
        self.gridLayout.addWidget(self.label_38, 11, 0, 1, 1)
        spacerItem = QtGui.QSpacerItem(618, 154, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.gridLayout.addWidget(self.pushButtonOutput, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_37, 10, 0, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(618, 155, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem1, 9, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxLessThan, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxDY, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxVMin, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxVMax, 4, 3, 1, 1)
    ...
    def retranslateUi(self, VectorDXF):
        ...
        self.doubleSpinBoxScale.setToolTip(_translate("VectorDXF", "factor from amplitude to vector length", None))
